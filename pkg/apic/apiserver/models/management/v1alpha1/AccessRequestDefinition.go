...
const (
	...
	AccessRequestDefinitionResource = "accessrequestdefinitions"
)
...
func init() {
	apiv1.RegisterGVK(_AccessRequestDefinitionGVK, AccessRequestDefinitionScope, AccessRequestDefinitionResource)
}
