...
const (
	...
	AssetRequestDefinitionResource = "assetrequestdefinitions"
)
...
func init() {
	apiv1.RegisterGVK(_AssetRequestDefinitionGVK, AssetRequestDefinitionScope, AssetRequestDefinitionResource)
}
