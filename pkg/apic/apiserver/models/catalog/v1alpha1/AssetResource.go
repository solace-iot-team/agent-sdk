...
const (
	...
	AssetResourceResource = "assetresources"
)
...
func init() {
	apiv1.RegisterGVK(_AssetResourceGVK, AssetResourceScope, AssetResourceResource)
}
...
func (res *AssetResource) FromInstance(ri *apiv1.ResourceInstance) error {
	...
	*res = AssetResource{ResourceMeta: ri.ResourceMeta, Spec: *spec}
