...
type EdgeTraceabilityAgentMergeFunc func(*v1alpha1.EdgeTraceabilityAgent, *v1alpha1.EdgeTraceabilityAgent) (*v1alpha1.EdgeTraceabilityAgent, error)

// Merge builds a merge option for an update operation
func EdgeTraceabilityAgentMerge(f EdgeTraceabilityAgentMergeFunc) v1.UpdateOption {
	return v1.Merge(func(prev, new apiv1.Interface) (apiv1.Interface, error) {
		p, n := &v1alpha1.EdgeTraceabilityAgent{}, &v1alpha1.EdgeTraceabilityAgent{}

		switch t := prev.(type) {
		case *v1alpha1.EdgeTraceabilityAgent:
			p = t
...
// Get -
func (c *UnscopedEdgeTraceabilityAgentClient) Get(name string) (*v1alpha1.EdgeTraceabilityAgent, error) {
...
// Update -
func (c *UnscopedEdgeTraceabilityAgentClient) Update(res *v1alpha1.EdgeTraceabilityAgent, opts ...v1.UpdateOption) (*v1alpha1.EdgeTraceabilityAgent, error) {
...
// List -
func (c *EdgeTraceabilityAgentClient) List(options ...v1.ListOption) ([]*v1alpha1.EdgeTraceabilityAgent, error) {
...
// Create -
func (c *EdgeTraceabilityAgentClient) Create(res *v1alpha1.EdgeTraceabilityAgent, opts ...v1.CreateOption) (*v1alpha1.EdgeTraceabilityAgent, error) {
	ri, err := res.AsInstance()
...
// Update -
func (c *EdgeTraceabilityAgentClient) Update(res *v1alpha1.EdgeTraceabilityAgent, opts ...v1.UpdateOption) (*v1alpha1.EdgeTraceabilityAgent, error) {
	ri, err := res.AsInstance()
	if err != nil {
		return nil, err
	}
